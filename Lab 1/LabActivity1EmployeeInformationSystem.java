...
public class LabActivity1EmployeeInformationSystem {
    ...
    public static void main(String[] args) {
        ...
        // first two blocks of code get the user's first and last names
        System.out.print("Enter your last name: ");
        String lastName = newScanner.nextLine();

        System.out.print("Enter your age: ");
        int employeeAge = newScanner.nextInt(); // We are asking for the user's age, we assign 'int' to this variable
     ...
     // Displaying employee details
        ...
        System.out.println("Employee age: " + employeeAge);
            ...
            // Calculating the daily salary based on hours worked and hourly wage
